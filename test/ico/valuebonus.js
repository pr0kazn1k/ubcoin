...
export default function (Token, Crowdsale, wallets) {
  ...
  let crowdsale;
  const valuebonuses = [
    {value: 20000000000000000000, bonus: 15},
    {value: 50000000000000000000, bonus: 25},
    {value: 100000000000000000000, bonus: 50}
  ];
  ...
  it('should correctly add new value bonus', async function () {
    ...
    await crowdsale.addValueBonus(360000000000000000000, 95, {from: owner}).should.be.rejectedWith(EVMRevert);
  });
